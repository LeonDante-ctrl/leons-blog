...
# import the create app function from app and create an instance of the entire app while passing in the configuration
# settings in the parameters of the function
